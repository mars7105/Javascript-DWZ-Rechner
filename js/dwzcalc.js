...
$(document).ready(function() {
	...
	$('#savecookie').click(function() {
		...
		content += '<br />Alter: ' + formular_Alter + '<br />DWZ: ' + formular_EigeneDWZ + '<br />Gegner DWZ:<br />' + jsonstring1 + '<br />Gegner Punkte:<br />' + jsonstring2;
		content += '<br />Zusätzliche DWZ Felder: ' + addrow + '</div>' + $('#ergebnis').html();
